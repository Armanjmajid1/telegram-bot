...
def check_message(message):
    mute_time = flood_mute_seconds(chat_id, user_id)
    mute_user(chat_id, user_id, mute_time)
    delete_and_warn(chat_id, user_id, message.message_id, f"🚫 به‌كارهێنه‌ر زۆر نامه‌ی ناردووە، ميوت كرا بۆ {mute_time} چرکە")
